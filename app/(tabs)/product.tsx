        ...
        <View >
          ...
          <View style={{gap:20, padding:20}}>
            <View style={{backgroundColor:'#F7F7F7', borderRadius:8, height: 74, width:350, padding:16}}>
              <Text style={{fontSize:14, fontWeight:'500', color: '#6A6A6A'}}>Some info has automatically been translatd.</Text>
          ...
          <View style={{borderTopWidth:1, borderColor:'#D9D9D9',  borderBottomWidth:1, margin:10 }}/>
          <View>
            <Text style={{fontSize:18, fontWeight:700, color:'#000000', marginBottom:20, paddingHorizontal:20}}>Where you will sleep</Text>
            <FlatList
            horizontal
          ...
          <View style={{paddingHorizontal:20, gap: 20}}>
            ...
            <View style={{gap:20}}>
              ...
              <TouchableOpacity style={{backgroundColor:'#c9c9c9ff', width: 362, height: 52, justifyContent:'center', alignItems:'center', borderRadius:8}}>
          ...
          <View style={{ gap: 20}}>
            ...
            <TouchableOpacity style={{backgroundColor:'#c9c9c9ff', width: 370, height: 42, justifyContent:'center', alignItems:'center', borderRadius:8, margin:10 }}>
          ...
          <View style={{flexDirection:'row', justifyContent:'space-between', alignItems:'center', paddingHorizontal:20}}>
            <View >
              <View style={{flexDirection:'row', gap: 3}}>
                <Text style={{color:'#6A6A6A', fontSize:16, fontWeight:'500', textDecorationLine:'line-through'}}>$271</Text>
                <Text style={{color:'#000000', fontSize:16, fontWeight:'500'}}>$230</Text>
              </View>
              <View>
                <Text style={{color:'#6A6A6A', fontSize:12, fontWeight:'400'}}>For 2 nights  Aug 1-3</Text>
              </View>          
            </View>
            <TouchableOpacity style={{backgroundColor:'#E31C5D', width: 144, height:49, borderRadius: 24, padding:14, justifyContent:'center', alignItems:'center'}}>
              <Text style={{color:'#FFFFFF', fontSize:14, fontWeight:'500', }}>Reserve</Text>
            </TouchableOpacity> 
          </View>
          <View>
          </View>       
